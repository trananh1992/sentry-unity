...
- Bump Native SDK from v0.16.2 to v0.17.0 ([#26](https://github.com/trananh1992/sentry-unity/pull/26))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#0170)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.16.2...0.17.0)
...
- Bump Cocoa SDK from v9.19.0 to v9.21.0 ([#2748](https://github.com/getsentry/sentry-unity/pull/2748), [#2756](https://github.com/getsentry/sentry-unity/pull/2756), [#2759](https://github.com/getsentry/sentry-unity/pull/2759))
...
- Bump Java SDK from v8.46.0 to v8.48.0 ([#2750](https://github.com/getsentry/sentry-unity/pull/2750), [#2758](https://github.com/getsentry/sentry-unity/pull/2758))
...
- Bump Native SDK from v0.15.2 to v0.15.3 ([#2755](https://github.com/getsentry/sentry-unity/pull/2755))
...
- Bump CLI from v3.3.5 to v3.4.1 ([#2656](https://github.com/getsentry/sentry-unity/pull/2656))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#341)
  - [diff](https://github.com/getsentry/sentry-cli/compare/3.3.5...3.4.1)

## 4.3.0

### Dependencies

- Bump Java SDK from v8.37.1 to v8.39.0 ([#2646](https://github.com/getsentry/sentry-unity/pull/2646))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8390)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.37.1...8.39.0)
